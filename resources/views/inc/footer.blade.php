...
<footer class="page-footer text-center text-md-left stylish-color-dark pt-0">
    ...
    <div class="container mt-5 mb-4 text-center text-md-left">
        <div class="row mt-3">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3">
                ...
                <hr class="blue mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                <p><i class="fas fa-home mr-3"></i> Cosmo City, Roodeport, 2188</p>
                <p><i class="fas fa-envelope mr-3"></i> info@example.com</p>
                <p><i class="fas fa-phone mr-3"></i> +27 11 234 567 88</p>
                <p><i class="fas fa-print mr-3"></i> +27 11 234 567 89</p>
            </div>
            <!--/.Fourth column-->
    ...
    <div class="footer-copyright py-3 text-center">
        <div class="container-fluid">
            © 2019 Copyright: <a href="#" target="_blank"> Ambani Matsedu </a>
        </div>
    </div>
    <!--/.Copyright -->
